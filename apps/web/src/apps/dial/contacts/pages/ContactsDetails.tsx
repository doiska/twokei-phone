...
import { useContactsNUI } from 'apps/dial/contacts/hooks/useContactsNUI';
	...
	return (
		<>
			<div className="flex h-full w-full flex-col gap-3">
				...
				<div
					className="flex w-2/3 content-center items-center place-self-center rounded-full bg-zinc-700 py-2 text-center text-sm first-letter:items-center">
