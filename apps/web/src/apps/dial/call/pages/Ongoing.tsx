...
import { CallDetails } from "@apps/dial/call/ongoing/components/CallDetails";
import { ProfileHolder, CallProfile } from "@apps/dial/call/ongoing/components/CallProfile";
...
const Ongoing: React.FC = () => {
	...
	return (
		<Container>
			<ProfileHolder>
				<CallProfile name={call.dialer}/>
				<CallDetails className="text-green-400" formattedTime="00:00"/>
			</ProfileHolder>
